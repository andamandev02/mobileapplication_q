...
class ClassBranch {
  ...
  static Future<void> counter({
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
                'https://somboonqms.andamandev.com/api/v1/queue-mobile/ticket-kiosk-list')
  ...
  static Future<void> counterdetail({
    ...
    try {
      ...
      final uri = Uri.parse(
              'https://somboonqms.andamandev.com/api/v1/queue-mobile/ticket-kiosk-detail')
          .replace(queryParameters: queryParameters);
      final response = await http.get(
        uri,
        headers: <String, String>{
  ...
  static Future<void> EndQueueReasonlist({
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
                'https://somboonqms.andamandev.com/api/v1/queue-mobile/reason-all')
            .replace(queryParameters: queryParameters),
        headers: <String, String>{
          HttpHeaders.contentTypeHeader: 'application/json; charset=UTF-8',
        },
